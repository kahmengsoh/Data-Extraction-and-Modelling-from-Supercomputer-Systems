...
def process_subject_row(row):
    ...
    temp_extract_path = osp.join("/common/wanglab/kahmengsoh", sub_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='listx.csv',
                        help='CSV file containing subject details like age, ID, and session')
    parser.add_argument('--output', type=str, default='datax.csv',
